...
export default function ModelInfo({
    ...
    return width > 1024 ? (
        <div
            dir="ltr"
            className={`py-0 sm:py-6 md:py-8 flex lg:py-10 xl:px-8 xl:py-8 2xl:px-8 min-w-full 2xl:w-11/12 overflow-scroll no-scrollbar lg:overflow-hidden lg:h-144 xl:h-158 2xl:h-216 aspect-3/4 ${+className}`}
        >
            <div className="basis-7/12 h-full flex w-full justify-center items-center lg:shadow-boxLeft rounded-3xl lg:rounded-r-none ">
                <img
                    src={sizes.original}
                    alt={name}
                    className="w-full max-h-full md:rounded-3xl md:rounded-b-none lg:rounded-tr-none lg:rounded-l-3xl "
                />
            </div>
