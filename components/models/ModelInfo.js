    ...
    return width > 1024 ? (
        ...
        >
            ...
            <div className="gap-2 md:gap-4 sm:rounded-b-3xl lg:rounded-bl-none lg:rounded-r-3xl flex flex-col basis-5/12 flex-grow lg:shadow-boxRight ">
                ...
                <div className="overflow-y-scroll no-scrollbar bg-white border-t-2 w-full grow h-52 lg:h-full rounded-3xl rounded-t-none relative ">
        ...
        >
            <div className="grid grid-cols-3 gap-3 pt-4 sm:gap-6 2xl:gap-8 rounded-3xl">
                ...
                <div className="items-center text-2xl sm:text-2xl md:text-3xl font-semibold text-center overflow-x-clip">
                    {name}
                </div>
            </div>
            ...
            <div className="gap-2 md:gap-4 rounded-b-3xl flex flex-col basis-5/12 flex-grow ">
