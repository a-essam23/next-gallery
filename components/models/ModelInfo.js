...
export default function ModelInfo({
    ...
    return (
        ...
        >
            <div className="basis-7/12 flex w-full justify-center items-center lg:shadow-md rounded ">
                <img
                    src={image}
                    alt={name}
                    className=" object:cover w-full md:rounded md:rounded-b-none lg:rounded-tr-none lg:rounded-l "
                />
            </div>
            <div className="gap-2 md:gap-4 sm:rounded-b lg:rounded-bl-none lg:rounded-r flex flex-col basis-5/12 flex-grow lg:shadow-lgb">
                ...
                <div className="overflow-y-scroll no-scrollbar bg-white border-t-2 w-full h-60 lg:h-full rounded relative ">
