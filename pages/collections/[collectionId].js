...
import { v4 } from 'uuid'
import { EmptyPlaceHolder, Layout, Model, ModelInfo, Searchbar } from '../../components'
...
export default function ModelPage({ models = [] }) {
  ...
  useEffect(() => {
    isShown ? (document.body.style.overflowY = 'hidden') : (document.body.style.overflowY = 'scroll')
  }, [isShown])
  return (
    <Layout>
      <Searchbar
